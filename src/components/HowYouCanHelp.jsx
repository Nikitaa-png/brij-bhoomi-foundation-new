  ...
  const focusAreas = [
    {
      ...
      desc: "Support initiatives such as Smart Classrooms, Digital Education, Scholarships, School Infrastructure, Computer Labs, Libraries, Teacher Development, and Career Guidance.",
      icon: <BookOpen size={18} className="text-[#B67A2A]" />,
    },
    {
      title: "Healthcare",
      desc: "Collaborate in projects involving Free Medical Camps, Blood Donation Drives, Health Awareness, Women's Health, Child Healthcare, Mental Health Programs, and Nutrition Campaigns.",
      icon: <Heart size={18} className="text-[#B67A2A]" />,
    },
    {
      title: "Environment & Sustainability",
      desc: "Support tree plantation, climate action, water conservation, waste management, plastic-free campaigns, biodiversity protection, and renewable energy awareness.",
      icon: <Sparkles size={18} className="text-[#B67A2A]" />,
    },
    {
      title: "Women Empowerment",
      desc: "Invest in programs focused on Skill Development, Entrepreneurship, Financial Literacy, Vocational Training, Digital Literacy, and Leadership Development.",
      icon: <UsersIcon size={18} className="text-[#B67A2A]" />,
    },
    {
      title: "Rural Development",
      desc: "Support projects related to Village Infrastructure, Drinking Water, Sanitation, Agriculture, Livelihood Development, and Rural Digital Inclusion.",
      icon: <Globe size={18} className="text-[#B67A2A]" />,
    },
    {
      title: "Youth Development",
      desc: "Enable young people through Skill Development, Career Guidance, Entrepreneurship, Internship Programs, Leadership Workshops, and Innovation Challenges.",
      icon: <Award size={18} className="text-[#B67A2A]" />,
    },
  ];
  ...
  const partnershipModels = [
    {
      ...
      desc: "Fund a complete social development project aligned with your CSR objectives.",
    },
    {
      title: "Annual CSR Partnership",
      desc: "Develop long-term strategic partnerships with measurable yearly impact.",
    },
    {
      title: "Employee Volunteering",
      desc: "Engage employees in meaningful volunteering experiences that strengthen team spirit while serving communities.",
    },
    {
      title: "Infrastructure Development",
      desc: "Support the construction or improvement of schools, healthcare facilities, libraries, sanitation systems, and community infrastructure.",
    },
    {
      title: "Education Sponsorship",
      desc: "Sponsor students, classrooms, digital learning centers, or scholarship programs.",
    },
    {
      title: "Healthcare Sponsorship",
      desc: "Support medical camps, health awareness programs, medical equipment, and preventive healthcare initiatives.",
    },
    {
      title: "Environmental Partnership",
      desc: "Collaborate on large-scale environmental sustainability projects.",
    },
  ];

  return (
    <section id="csr-partnership" className="w-screen py-28 px-[8vw] lg:py-36 flex items-center bg-[#FAF7F0] relative z-20 border-t border-[#D8C6A8] overflow-hidden text-left">
      ...
      <div className="absolute inset-0 bg-[#FAF7F0] overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.055] mix-blend-overlay animate-drift-texture" style={{ filter: "url(#grainy-paper-help)" }} />
      </div>
