...
export default function WomenEmpowerment() {
  ...
  return (
    <section id="empowerment" className="w-screen py-28 px-[8vw] lg:py-36 flex items-center bg-[#F2E8D6] relative z-20 border-t border-[#D8C6A8] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#F2E8D6] overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.05] mix-blend-overlay animate-drift-texture" style={{ filter: "url(#grainy-paper-empowerment)" }} />
      </div>
