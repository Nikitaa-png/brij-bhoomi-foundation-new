...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="w-screen px-[8vw] py-28 lg:py-36 flex items-center bg-[#FAF7F0] relative z-20 border-t border-[#1f1a14]/5 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#FAF7F0] overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-[0.055] mix-blend-overlay animate-drift-texture" style={{ filter: "url(#grainy-paper-gallery)" }} />
      </div>
