...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-screen px-[8vw] py-28 lg:py-36 flex items-center bg-transparent relative z-20 border-t border-[#D8C6A8] overflow-hidden">
      
      <GrainyBackground 
        id="grainy-paper-contact" 
        bgClass="bg-[#F2E8D6]" 
