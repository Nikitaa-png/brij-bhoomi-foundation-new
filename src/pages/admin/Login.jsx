...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("brij_admin_session")) {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (email === "admin@brijbhoomi.org" && password === "admin123") {
        localStorage.setItem("brij_admin_session", "true");
        if (rememberMe) {
          localStorage.setItem("brij_admin_remember", email);
        } else {
          localStorage.removeItem("brij_admin_remember");
        }
        setIsLoading(false);
        navigate("/admin/dashboard", { replace: true });
      } else {
        setIsLoading(false);
        setErrorMsg("Invalid credentials. Try admin@brijbhoomi.org / admin123.");
      }
    }, 600);
  };
  ...
  return (
    <>
      <PageMeta
        title="Admin Login - Brij Bhoomi Foundation"
        description="Access the administrator dashboard and coordinate social impact campaigns."
      />
      ...
      <div className="min-h-screen text-[#111111] font-inter flex flex-col justify-center items-center px-4 relative select-none overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('/brij_kund.png')" }}
        ></div>
        ...
        <div className="w-full max-w-md bg-[#FCFAF5] border border-[#D8C6A8]/70 rounded-[16px] p-8 shadow-lg space-y-6 z-20 relative">
          ...
          <div className="text-center space-y-2">
            <Link to="/" className="flex flex-col items-center group mb-2">
              ...
              <span className="text-[8px] uppercase tracking-[0.3em] text-[#8B6F47] font-semibold mt-0.5 transition-colors duration-300 group-hover:text-[#111111]">
                Foundation
              </span>
            </Link>
            ...
            <h1 className="text-xl font-sora font-semibold text-[#111111] tracking-tight pt-2">Sign In to Dashboard</h1>
            <p className="text-[11px] text-[#6B7280] font-medium">Enter your credentials below to access administrative features.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs text-left">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  placeholder="admin@brijbhoomi.org"
                  value={email}
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={() => alert("Credentials verification help: Check password 'admin123'")}
          ...
          <div className="pt-4 border-t border-[#D8C6A8]/20 text-[10px] text-[#6B7280] text-center font-medium leading-relaxed">
            Demo Details:<br />
            Email: <span className="text-[#111111] font-bold">admin@brijbhoomi.org</span><br />
            Password: <span className="text-[#111111] font-bold">admin123</span>
          </div>
