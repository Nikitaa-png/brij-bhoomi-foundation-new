  ...
  return (
    <>
      <PageMeta
        ...
        description="Read the Terms and Conditions governing use of the Brij Bhoomi Foundation website, including rules for donations, intellectual property, disclaimers, and governing law."
      />
